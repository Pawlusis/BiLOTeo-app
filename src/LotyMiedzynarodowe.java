...
public class LotyMiedzynarodowe extends JFrame
{
	...
	public LotyMiedzynarodowe(Logowanie type1)
	{
		Container c =getContentPane();
		c.setLayout(new BorderLayout());
		String[] sItem1={"Wroclaw"};
		String[] sItem2={"Bali","Bangkok","Kair","Kapsztad","Chicago","Dubai","Frankfurt","HongKong","Istanbul","Londyn","LosAngeles","Melbourne","New York","Paryż","Rzym","SanFrancisco","shanghai","Singapore","Sydney","Toronto"};
		...
		LBookingDetails = new JLabel("Dane Rezerwacji");
		LFrom = new JLabel("Z         :");
		LTo = new JLabel("Do             :");
		LBookingDate = new JLabel("Data Rezerwacji:");
